...
public class Slime3 extends Entity implements IAttackable {
    ...
    public Slime3(int x, int y, int speed, GamePanel gp) {
        ...
        try {
            ...
            this.bufferedImage = SpriteCache.get("/Assets/Enemy/PNG/Slime3/With_Shadow/Slime3_Idle_with_shadow.png", this);
            ...
            this.bufferedImage = SpriteCache.get("/Assets/Enemy/PNG/Slime3/With_Shadow/Slime3_Death_with_shadow.png", this);
            ...
            this.bufferedImage = SpriteCache.get(
                    "/Assets/Enemy/PNG/Slime3/With_Shadow/Slime3_Attack_with_shadow.png", this);
