...
public class FireSlime extends Entity implements IAttackable {
    ...
    public FireSlime(int x, int y, int speed, GamePanel gp) {
        ...
        try {
            ...
            this.bufferedImage = SpriteCache.get("/Assets/Enemy/PNG/Slime1/With_Shadow/Slime1_Idle_with_shadow.png", this);
            ...
            this.bufferedImage = SpriteCache.get("/Assets/Enemy/PNG/Slime1/With_Shadow/Slime1_Death_with_shadow.png", this);
            ...
            this.bufferedImage = SpriteCache.get(
                    "/Assets/Enemy/PNG/Slime1/With_Shadow/Slime1_Attack_with_shadow.png", this);
        ...
        if (Activitynow == 0) {
            ...
            if (isChasing) {
                ...
                if (isMoving) {
                    ...
                    boolean nabrakX = gp.collidesWithWall(nextX, y, hitbox)
                            || gp.collidesWithClosedGate(nextX, y, hitbox);
                    boolean nabrakY = gp.collidesWithWall(x, nextY, hitbox)
                            || gp.collidesWithClosedGate(x, nextY, hitbox);
    ...
    public void checkPlayerCollision(Player player) {
        ...
        // 2. TRIGGER DAMAGE: Berikan damage TEPAT di pertengahan animasi (misal Frame
        // ke-5)
        if (this.Activitynow == 1 && this.attackFrame == 5 && !this.hasDealtDamage) {
            ...
            if (this.getAttackHitboxArea().intersects(player.getHitbox())) {
                ...
                // (Untuk berjaga-jaga jika player lari bersembunyi ke balik tembok saat animasi
                // memukul diputar)
