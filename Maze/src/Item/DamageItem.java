...
public class DamageItem extends Item {
    ...
    public DamageItem(String namaSenjata, int damage) {
        ...
        switch (namaSenjata) {
            case "Pedang Kayu": 
                namaFileGambar = "Icon28_01.png"; break;
            case "Pedang Besi": 
                namaFileGambar = "Icon28_02.png"; break;
            case "Kapak Ganda": 
                namaFileGambar = "Icon28_03.png"; break;
            case "Pedang Petir": 
                namaFileGambar = "Icon28_04.png"; break;
            default: 
                namaFileGambar = "Icon28_01.png"; break; // Jika salah ketik, default ke Pedang Kayu
        }
